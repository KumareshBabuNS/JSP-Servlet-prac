...
import com.webtools.utility.Validations;
 ...
 * @author richa
 */
@WebFilter(filterName = "AdditionFilter", urlPatterns = {"/additioncontroller"})
//@WebFilter(filterName = "", servletNames = {"AdditionServlet"}, dispatcherTypes = {DispatcherType.REQUEST})
...
//        if (debug) {
//            log("AdditionFilter:DoBeforeProcessing");
//        }
//
...
//            throws IOException, ServletException {
//        if (debug) {
//            log("AdditionFilter:DoAfterProcessing");
//        }
//
...
//    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        boolean valid = vObj.isValid(movieTitle, movieActor, movieActress, movieGenre, movieYear);
...
//        }   
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                System.out.println("AdditionFilter: Initializing filter");
            }
        }
    }
//
...
//        }
//        StringBuffer sb = new StringBuffer("AdditionFilter(");
...
//            if (debug) {
//                System.out.println("AdditionFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
//            }
//            
//            if (localParams == null) {
...
//            if (debug) {
//                System.out.println("AdditionFilter::getParameter(" + name + ") localParams = " + localParams);
//            }
//            if (localParams == null) {
...
//            if (debug) {
//                System.out.println("AdditionFilter::getParameterValues(" + name + ") localParams = " + localParams);
//            }
//            if (localParams == null) {
...
//            if (debug) {
//                System.out.println("AdditionFilter::getParameterNames() localParams = " + localParams);
//            }
//            if (localParams == null) {
...
//            if (debug) {
//                System.out.println("AdditionFilter::getParameterMap() localParams = " + localParams);
//            }
//            if (localParams == null) {
